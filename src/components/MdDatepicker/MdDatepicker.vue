<template>
  <md-field :class="['md-datepicker', { 'md-native': !this.mdOverrideNative }]" :md-clearable="mdClearable" @md-clear="onClear">
    ...
    <md-input :type="type" ref="input" v-model="inputDate" @focus.native="onFocus" :pattern="pattern" :disabled="disabled" :readonly="readonly" :required="required" inputmode="none" />
